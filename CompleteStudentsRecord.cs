...
{
    public partial class CompleteStudentsRecord : Form
    {
        public CompleteStudentsRecord()
        {
            InitializeComponent();
        }
        ...
        private void glassButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (dt.Read())
                {
                    ...
                    row.Cells[0].Value = dt.GetString(3);
                    row.Cells[1].Value = dt.GetString(1);
                    row.Cells[2].Value = dt.GetString(2);
                    row.Cells[3].Value = dt.GetString(4);
                    row.Cells[4].Value = dt.GetString(8);
                    row.Cells[5].Value = dt.GetString(5);
                    row.Cells[6].Value = dt.GetInt32(0).ToString();
